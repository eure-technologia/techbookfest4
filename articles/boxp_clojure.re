...
Clojureは、コードのビルド・ライブラリの依存管理・REPLの立ち上げ等のコーディングに必要な周辺環境を「Leiningen」と言うツールを用いて行います。
...
しかしここでは、簡単の為に最もシンプルなLeiningenに標準搭載されているボイラープレートから使って行きましょう。
